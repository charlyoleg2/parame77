// cylinder.ts
// simple cylinder shape for experimenting systemix
...
function pGeom(t: number, param: tParamVal, suffix = ''): tGeom {
	...
	try {
		...
		rGeome.sub = {};
		// finalize
		rGeome.logstr += 'cylinder drawn successfully!\n';
...
const cylinderDef: tPageDef = {
	pTitle: 'cylinder',
	pDescription: 'simple cylinder shape for experimenting systemix',
	pDef: pDef,
	pGeom: pGeom
};
